    ...
    return (
        <div className="home-container">
            ...
            <header className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
                ...
                <div className = "mt-4">
                    <button className="btn btn-primary btn-lg me-3" onClick={() => navigate('/register')}>Get Started</button>
                    <button className="btn btn-outline-light btn-lg" onClick={() => navigate('/login')}>Login</button>
                </div>
            </header>
            ...
            <footer className="bg-dark text-white text-center py-3">
                <p className="mb-0">&copy; {new Date().getFullYear()} Personal Budget Tracker. All rights reserved.</p>
            </footer>
